...
// The actual live login / code-entry page. Hardcoded as the default rather
// than derived from COURSE_SITE_URL, since that env var has been the source
// of repeated wrong-page links — if COURSE_SITE_URL is set in Vercel, it's
// used as-is (no path manipulation), otherwise this exact confirmed URL is used.
const LOGIN_URL = process.env.COURSE_SITE_URL || 'https://armonia-course.vercel.app/course/';
