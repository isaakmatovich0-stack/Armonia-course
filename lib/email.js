...
const COURSE_SITE_URL = process.env.COURSE_SITE_URL || 'https://armoniaconnect.com/course';
// Always resolve to the actual login / code-entry page explicitly, regardless
// of whether COURSE_SITE_URL has a trailing slash or points at the course
// root vs. a specific file — this is the page where a code gets typed in.
const LOGIN_URL = `${COURSE_SITE_URL.replace(/\/+$/, '')}/index.html`;
